...
fig1, ax1, (t_traj, x_traj, y_traj, z_traj) = plot_positions(coeffs, Ts, segment_times, order=5)
fig2, ax2, (t_vel, x_vel, y_vel, z_vel) = plot_velocities(coeffs, Ts, segment_times, order=5)
fig3, ax3, (t_acc, x_acc, y_acc, z_acc) = plot_accelerations(coeffs, Ts, segment_times, order=5)
fig4, ax4, (t_jerk, x_jerk, y_jerk, z_jerk) = plot_jerks(coeffs, Ts, segment_times, order=5)
fig5, ax5, (t_snap, x_snap, y_snap, z_snap) = plot_snaps(coeffs, Ts, segment_times, order=5)
