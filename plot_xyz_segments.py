...
fig1, ax1, (t_traj, x_traj, y_traj, z_traj) = plot_positions(coeffs, Ts, segment_times)
fig2, ax2, (t_vel, x_vel, y_vel, z_vel) = plot_velocities(coeffs, Ts, segment_times)
fig3, ax3, (t_acc, x_acc, y_acc, z_acc) = plot_accelerations(coeffs, Ts, segment_times)
fig4, ax4, (t_jerk, x_jerk, y_jerk, z_jerk) = plot_jerks(coeffs, Ts, segment_times)
fig5, ax5, (t_snap, x_snap, y_snap, z_snap) = plot_snaps(coeffs, Ts, segment_times)
fig6, ax6, (t_forces, f1, f2, f3, f4) = plot_forces(coeffs, Ts, segment_times)

# Print trajectory information
print_trajectory_info(coeffs, Ts, total_time)
